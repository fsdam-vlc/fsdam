...
class CFG:
    ...
    # we trained on lambda ai; we will provide the exact directory style, so that you can train in one click
    # you can toggle to ablation by playing with true/ false
    # ===== Data =====
